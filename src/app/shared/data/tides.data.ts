...
/**
 * Les marées en Polynésie française, et pourquoi celles de la Société sont un
 ...
 * la marée suit l'horloge et non la lune, et les mêmes heures reviennent tous les
 ...
 * facteur de marnage, et la régularité des heures se dégrade en mortes-eaux.
 *
...
export const TIDE_GUIDANCE: readonly TideGuidance[] = [
  {
    ...
    tips: [
      ...
      'Le soleil commande les heures, mais la lune commande encore l’amplitude : le cycle vives-eaux et mortes-eaux, sur 14,77 jours, pèse plus du double du cycle saisonnier. Comptez environ 25 cm de marnage autour de la nouvelle et de la pleine lune, et bien moins entre les deux.',
      'Corollaire utile : la règle des heures fixes est presque parfaite en vives-eaux, et nettement moins fiable en mortes-eaux, quand la marée est de toute façon si faible qu’elle ne change plus rien.',
    ],
  },
  {
    ...
    regime: 'lunaire',
    summary:
      'Changez de logique : la marée y est lunaire, elle se décale d’environ 50 minutes par jour, et l’horloge de Tahiti ne s’applique pas.',
    highTideHours: [],
    lowTideHours: [],
    amplitudeCm: 'moins de 30 cm dans les lagons du nord et du centre, jusqu’à 60 cm vers l’est',
    tips: [
      'Les courants de passe sont la vraie affaire : jusqu’à 8 nœuds à Tiputa, à Rangiroa, et 9 nœuds en sortie de la passe Garuae à Fakarava par forte houle de sud. Le courant entrant dépasse rarement 3 nœuds.',
      ...
      'Une forte houle de sud qui déferle par dessus le récif remplit le lagon. Le niveau intérieur monte, le courant sortant s’installe en permanence, et le courant entrant peut ne jamais revenir, quelle que soit l’heure de la marée.',
  ...
  },
  {
    ...
    regime: 'lunaire',
    summary:
      'Le seul archipel où la marée change vraiment quelque chose : pas de lagon, pas de barrière, et un marnage nettement plus fort.',
    highTideHours: [],
    lowTideHours: [],
    ...
    tips: [
      ...
      'Pas de lagon protecteur : la houle arrive directement à la côte, et la baignade tranquille est rare.',
    ],
  },
  {
...
/** Ce que la règle des heures fixes ne dit pas, et ne peut pas dire. */
